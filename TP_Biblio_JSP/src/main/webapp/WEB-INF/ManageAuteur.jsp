                    ...
                    <div class="card-body">
                        <div class="col-sm-12">
                            <form action="<c:url value="/manageAuteur"></c:url>" method="POST">
                                ...
                                <div class="form-group col-sm-12">
                                    <b>Prénom</b>
                                    <input type="text" id="prenom" name="prenom" class="form-control" placeholder="Prénom"  value='<c:out value="${prenom}" />' />
                                </div>
                                <br />
                                <div class="form-group col-sm-12">
                                    <b>Téléphone</b>
                                ...
                                <div class="form-group col-sm-12">
                                    <b>Email</b>
                                    <input type="text" id="email" name="email" class="form-control" placeholder="Email" value='<c:out value="${email}" />' />
                                </div>
                                <br />
                                <br />
                                <hr />
